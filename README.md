...
Article DOI: [10.1021/jacs.6c11486](https://doi.org/10.1021/jacs.6c11486)
...
Both models use device parameters, Morgan fingerprints (radius 8, 2048 bits), and RDKit molecular descriptors as input. This repository provides a database snapshot, the training matrices used for model fitting, pre-trained models, the inference pipeline, and example inputs.
...
python examples/run_prediction.py --input data/your_input.csv
```
...
├── data/                   # Database snapshot, training matrices, input template, and example inputs
